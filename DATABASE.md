...
CREATE TABLE ledger_entries (
    ...
    transaction_id  TEXT NOT NULL,             -- groups debit + credit into one logical transaction
    merchant_id     TEXT NOT NULL,
...
-- Enforce double-entry: sum of debits = sum of credits per transaction
-- This is enforced at the application level in Ledger Service,
-- but we also have a periodic check:
-- SELECT transaction_id, SUM(debit_amount), SUM(credit_amount)
-- FROM ledger_entries
